...
function numberedClause(num: number, text: string) {
  return new Paragraph({
    alignment: AlignmentType.JUSTIFIED,
    spacing: { after: 200 },
  ...
  const doc = new Document({
    sections: [{
      ...
      children: [
        ...
        numberedClause(3, clause3Text),
        numberedClause(4,
          `Il ritardo superiore a 20 (venti) giorni nel pagamento anche di una sola rata mensile, comporterà la risoluzione del contratto per grave inadempimento della ${conduttoreLabel}.`
        ),
        numberedClause(5,
          `In caso di ritardo nel pagamento del canone, la ${conduttoreLabel} dovrà corrispondere gli interessi moratori al tasso annuo del 5%.`
        ),
        numberedClause(6,
          `La sublocazione e la cessione del contratto sono vietate sotto pena di risoluzione immediata del contratto.`
        ),
        numberedClause(7,
          `Nel caso che la ${conduttoreLabel} non rispetti la scadenza del contratto, ritardando il rilascio dell'immobile, sarà obbligata al risarcimento del danno.`
        ),
        numberedClause(8,
          `Le spese occorrenti per l'ordinaria manutenzione, amministrazione e assicurazione dell'immobile sono a carico della ${conduttoreLabel}. Manutenzioni e interventi straordinari sono a carico della ${locatoreLabel}, la quale potrà richiedere un aumento del canone pari al tasso legale del capitale impiegato; se non corrisposto da parte della ${locatoreLabel}, sarà considerato inadempimento di gravità tale da giustificare la risoluzione del contratto.`
        ),
        numberedClause(9,
          `La ${conduttoreLabel} è obbligata a pagare le spese per la luce e la pulizia delle scale, per il riscaldamento ed ogni utenza da essa goduta, oltre alla vuotatura delle fosse biologiche.`
        ),
        numberedClause(10,
          `Ogni eventuale lavoro, modifica e/o addizione che la ${conduttoreLabel} riterrà di eseguire, dovrà essere autorizzato dalla proprietaria e sarà ad esclusivo onere e spesa degli stessi esecutori, con totale esonero della ${locatoreLabel}. Migliorie e addizioni, al rilascio, rimarranno acquisite all'immobile, senza alcun compenso.`
        ),
        numberedClause(11,
        ...
        numberedClause(12,
          `La ${conduttoreLabel} è obbligata a mantenere l'impianto elettrico, l'impianto di riscaldamento ed ogni altro a norma di legge e, comunque, in efficienza tale da garantire la sicurezza assoluta.`
        ),
        numberedClause(13,
          `Vale tra le parti la clausola "solve et repete", ovvero, la ${conduttoreLabel} non potrà in alcun caso sottrarsi all'obbligo di pagamento mensile del canone di locazione come previsto nel presente contratto. Eventuali eccezioni e/o contestazioni dovranno essere fatte valere in separata sede e non potranno legittimare la sospensione del pagamento del citato canone di locazione.`
        ),
        numberedClause(14, `L'immobile è dotato di ogni impianto a norma di legge.`),
        numberedClause(15, energyClause),
